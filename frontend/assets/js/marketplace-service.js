// Marketplace Service - Handle smart contract interactions for NFT purchases
class MarketplaceService {
    ...
    // Purchase recipe authorization using the correct function
    async purchaseRecipe(recipeTokenId, price) {
        try {
            ...
            // Execute purchase using the correct function name
